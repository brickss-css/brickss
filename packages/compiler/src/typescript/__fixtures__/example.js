...
var styles = function brickss_1(state) {
    ...
    runtime_1._i("example-84ff5", ".example-84ff5 { background: green;" + ((myVar.defaultValue ? "font-size: " + myVar.defaultValue + ";" : "") + "font-size: " + "var(--" + myVar.name + ", " + (myVar.defaultValue || "") + ");" + ((myVar2.defaultValue ? "line-height: " + myVar2.defaultValue + ";" : "") + "line-height: " + "var(--" + myVar2.name + ", " + (myVar2.defaultValue || "") + ");" + ("} .example-84ff5__something { color: red; padding: 10px; } .example-84ff5--inverse .example-84ff5__something { color: #fff; }" + ""))));
